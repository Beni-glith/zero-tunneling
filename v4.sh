...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/Beni-glith/izin/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Beni-glith/zero-tunneling/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/Beni-glith/zero-tunneling/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
